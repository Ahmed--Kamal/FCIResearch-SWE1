<%-- 
    Document   : JoinGroup
    Created on : Dec 26, 2014, 1:40:38 PM
    Author     : Sho3la
--%>
...
%>
<form name ="f2" method="post" action="JoinGroupAuthentication" class="login">
    ...
    <br><br>
    <input type="text" name = "name" placeholder="Group Name to join" id="name">
    </p>
    <p>
