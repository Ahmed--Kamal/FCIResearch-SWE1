<%-- 
    Document   : Research
    Created on : Dec 20, 2014, 3:34:10 PM
    Author     : Sho3la
--%>
	...
	<div id="head" class="parallax" parallax-speed="2">
		<h1 id="logo" class="text-center">
			...
			<span class="tagline">User Mail<br>
				<a href=""><%= String.valueOf(em)%></a></span>
		</h1>
	</div>
...
<form name ="f" method="post" action="ResearchAuthentication" class="login">
    ...
    <p class="about-author">
      © 2014–2015 <a href="https://www.facebook.com/Sho3laaa" target="_blank">Khaled Ahmed </a>
